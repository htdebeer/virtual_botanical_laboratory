...
where computers meet biology* (Levy 1992). In this book, Levy describes
...
*Hackers* (Levy 2010), it was still an interesting read. What piqued my
...
algorithmic beauty of plants* (Prusinkiewicz and Lindenmayer 1990).
Given its age, I had little hope in finding this book. To my surprise,
it is available
...
Seeing the turtle interpretation, I tried to read (Prusinkiewicz and
Lindenmayer 1990) using a [constructionist
...
chapters below. For more information about
`virtual_botanical_laboratory`, I refer you to its
...
algorithmic beauty of plants* (Prusinkiewicz and Lindenmayer 1990). Some
more advanced features from later in that book needs to be implemented
still.
...
Prusinkiewicz, Prezemyslaw, and Aristid Lindenmayer. 1990. *The
